class Main {
  ...
  void init(){
    ...
    if (60 <= student1.calculateAvg() && student1.calculateAvg() >= 70) {
      if (student1.gradeLevel < 11) {
      System.out.println(student1.firstName);
      }
    }
    
    if (60 <= student2.calculateAvg() && student2.calculateAvg() >= 70) {
      if (student2.gradeLevel < 11) {
      System.out.println(student2.firstName);
      }
    }
