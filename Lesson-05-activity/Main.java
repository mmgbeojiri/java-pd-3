...
int totalEggs = 100;
int howManyFilledBaskets = (100/12);
int howManyLeftOver = 100%12;

System.out.println("Filled Baskets: " + howManyFilledBaskets);
System.out.println("How Many Left Over: " + howManyLeftOver);
